       ...
       <div class="nav_bar1"> 
        ...
        <div id="About1" class="About1">
              ...
              <div class="about-me">
                ...
                <div class="me">
                  ...
                  style={{ width: '600px', height: '270px', color:'black',border:'0',border:'none'}}/>
                  </p>
                  </div>
                  </div>
        </div>
        ...
        <div class="Service1" id="Service1">
          ...
          <div>
            <Container style={{marginLeft:'15%',marginTop:'5%'}}>
              ...
              style={{ width: '300px', height: '100px', color:'black',border:'0', marginTop:'5%'}}/></p>
              </div>
                </Col>
                <Col>
                <div  class='con'>
        ...
        <div class="Skills1" id="Skills1">
          <h1 class="about-h1"><InputBox placeholder="Skills" style={{color:'#FDD023'}}/></h1>
            <Container style={{marginLeft:'18%', padding:'5%'}}>
                <Row style={{display:'flex'}}>
        ...
        <div class="Education1" id="Education1">
          <h1 class="about-h1"><InputBox placeholder="Education" style={{color:'#FDD023', marginLeft:'30%'}}/></h1>
          <div class="educ">
          <Container>
            <Row style={{display:'flex'}}>
              <Col>
